  ...
  return (
    ...
    <div className='flex items-center justify-between border-b-[0.5px] border-[#30363d] p-4'>
        ...
        <div className='flex items-center justify-between px-2 py-1 rounded-md bg-[#0d1117] border-[0.5px] border-[#30363d] w-full md:w-auto'>
            ...
            <div className='md:px-8 px-2 text-white whitespace-nowrap overflow-hidden text-[14px] text-ellipsis'>Beginner Unity Course</div>
    ...
    <div className='flex items-stretch'>
        ...
        <img src="https://i.postimg.cc/zB8qhvkz/2qqffzh4c6h81.jpg" style={{ transform: 'scale(1)', marginBottom: "2em"  }} alt="BlackBerry logo" height="44" className="my-3  w-[900px]"/>
        </div>
        <div className='md:block hidden border-l-[0.5px] border-[#30363d] w-full'>
            ...
            <div className='px-6 flex items-center justify-between h-full bg-[#040d21]'>
              ...
              <img src="https://i.postimg.cc/NMpgYYvd/game.png"  style={{ transform: 'scale(1)' }} alt="Google logo" height="44" className="my-3 w-[900px]"/>
            </div>
        </div>
    </div>
</div>
