    ...
    <div className='max-w-[1280px] mx-auto'>
        <div className='flex md:pl-10 space-x-3 md:space-x-10'>
            ...
            <div className='md:w-10/12 mb-24'>
                <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.4, duration:0.3}} viewport={{once:false}} className="text-[20px] md:text-2xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '200ms'}}></motion.div>  
                <motion.h3 initial={{opacity:0}} whileInView={{opacity:1}} transition={{delay:0.5,duration:0.3}} viewport={{once:false}} className="text-[28px] md:text-[40px] max-md:leading-8 max-lg:leading-10 lg:text-5xl mb-7 font-medium text-white js-build-in-item build-in-slideX-left build-in-animate" style={{transitionDelay: '300ms'}}>
                    <span className="text-[#7ee787]">Discover the world of Unity and Coding.</span>
                    While unlocking countless skills and other exciting possibilities along the journey to create your very own game.
                </motion.h3>
            </div>
        </div>
        <CodeEditor/>
            ...
            <div className='flex justify-between md:space-x-10 max-md:flex-col'>
                <HoverCard backgroundColor='#7ee787' direction='flex-col' left='0'>
                    <div className='md:flex flex-col flex-1 p-8 sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 '>
                        <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]"><span className='text-white font-semibold'>Discover the power of GitHub</span> ,where you'll learn the ins and outs of collaborating with fellow students and beyond. Dive into user-friendly techniques for seamless teamwork and create an engaging learning community together.</p>
                        <div>
                ...
                <HoverCard backgroundColor='#7ee787' direction='flex-col' left='-400px'>
                    <div className='flex-col  flex-1 p-8 '>
                        <p className="text-xl md:text-2xl mb-6 font-medium text-[#7d8590] m-0 p-0"><span className='text-white font-semibold'>Industry skills </span> that will help you learn and have fun at the same time.</p>
                        <div>
                    ...
                    <div className='overflow-hidden rounded-s-lg'>
                    <img className="w-full  h-auto" width="800" height="400" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://i.postimg.cc/d3X2mcb5/099621-larger.png" />
                    <img className="w-full  h-auto" width="800" height="400" loading="lazy" decoding="async" alt="" aria-hidden="true" src="https://i.postimg.cc/XqJDJx8b/81-Vdqkksbu-L-1.png" />
                    </div>
                </HoverCard>
            </div>
        </div>
