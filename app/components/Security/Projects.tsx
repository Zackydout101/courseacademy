    ...
    <div className='lg:pl-24 md:pl-16 pl-6'>
        <div className='flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row'>
            <div className='py-4 mb-2 w-full'>
                <motion.div initial={{opacity:0, x:30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3}} className='md:pr-6'>
                    <h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]"><span className='font-semibold text-white'>Our 4 years of experience</span>   have led us to affirm that at CourseAcademy, the optimal method of learning is through hands-on experience. With all of us possessing teaching experience, we stand prepared to serve our future students.</h2> 
                    <a onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.youtube.com/channel/UCTYXT-TktUaYZgbKkVZBsFw" className='py-1 inline-block text-xl text-white font-semibold'>
                        Watch Our Past Courses
                        ...
                        <p className="mb-3 md:text-md text-base font-small text-white">(More Advanced Courses)</p>
            ...
            <motion.div initial={{opacity:0, x:30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3}} className='py-4 px-6 w-full'>
                <div className='relative'>
                    <div className='relative'>
                        ...
                        <img src="https://i.postimg.cc/Zn9D0MwH/imagebackground.png" alt="" loading="lazy" decoding="async" width="1190" height="1004" className="w-full h-auto d-block rounded-lg" />
                        </div>  
                    </div>
                </div>
            </motion.div>
        ...
        <motion.div initial={{opacity:0, x:-30}} whileInView={{opacity:1, x:0}} transition={{type:'tween', duration:0.3, delay:0.2}} className='mb-10 md:mb-32 pb-4 '>
            <div className='py-4 text-left'>
                ...
                <h3 className="text-[#939aff] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">We have taught over 100k Students</h3>
                <p className="mb-3 md:text-xl text-base font-medium text-white">We offer premium courses tailored to suit different age demographics.</p>
            </div>
        </motion.div>
    </div>
  </div>
